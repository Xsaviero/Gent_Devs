...
requirejs(['./WorldWindShim',
    ...
    function (WorldWind,
        ...
        var placemarkPosition = new WorldWind.Position(35.95, -93.04, 1e2);
        var placemarkPosition2 = new WorldWind.Position(40.37, -80.25, 1e2);
        var placemarkPosition3 = new WorldWind.Position(41.14, -88.13, 1e2);
        var placemark = new WorldWind.Placemark(placemarkPosition, false, placemarkAttributes);
        var placemark2 = new WorldWind.Placemark(placemarkPosition2, false, placemarkAttributes);
        var placemark3 = new WorldWind.Placemark(placemarkPosition3, false, placemarkAttributes);
